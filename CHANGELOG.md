...
- `setting.json` Adding the mcp registry workflow the CI/CD release
...
### Added
- hotfix for  CI/CD workflows

### Fixed
- update release process to handle existing releases and sign artifacts (#16)
